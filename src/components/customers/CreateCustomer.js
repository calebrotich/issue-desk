          ...
          <section className="section is-main-section">
              <div className="card">
                  ...
                  <div className="tile is-ancestor">
                      ...
                      <div className="tile is-parent">
                          <img src="https://freewebillustrations.com/static/images/preview/delesign-free-designs-privacy-and-policy.png" alt={'Create User'}  style={{height: '420px',margin: 'auto'}}/>
                      </div>
                  </div>
